	...
	public static void main(String args[]) throws ParseException {
		...
		try {
			...
			do {
				...
				switch (choice) {
				case 1: // INSERT new patient and realted prescription
				...
				case 4: //update name and email of patient
					...
					System.out.println("Enter pateint id to update details.");
					
					id=in.nextInt();
					
					System.out.println("Enter new name for the patient");
					...
					System.out.println("Enter new email for the patient");
